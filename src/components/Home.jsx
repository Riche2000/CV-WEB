  ...
  return (
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
            ...
            <div>
            <div className='hidden md:flex relative left-40 z-0 ml-20 before:absolute before:-top-9 before:-left-9 before:rounded-2xl before:w-2/3 before:h-full before:border-2 before:border-white before:z-[-1]'>
