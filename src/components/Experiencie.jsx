...
const Experience = () => {
    ...
    return (
      <div name="experience" className="bg-gradient-to-b pt-24 from-cyan-700 via-sky-800 to-blue-900 w-full h-scrren">
        <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
          <div>
            <p className="text-4xl font-bold inline border-b-4 border-sky-500">Experience</p>
